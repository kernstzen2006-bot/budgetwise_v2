...
var Rectangle = function Rectangle2(rectangleProps) {
  var props = _objectSpread$l(_objectSpread$l({}, defaultProps$1), rectangleProps);
...
var Trapezoid = function Trapezoid2(props) {
  var trapezoidProps = _objectSpread$h(_objectSpread$h({}, defaultProps), props);
  var pathRef = reactExports.useRef();
...
function typeGuardSectorProps(option, props) {
  ...
  return _objectSpread$e(_objectSpread$e(_objectSpread$e({}, props), option), {}, {
    cx,
    cy
  });
}
...
var _excluded$5 = ["shape", "activeShape", "activeIndex", "cornerRadius"], _excluded2$3 = ["value", "background"];
function _typeof$g(o) {
  "@babel/helpers - typeof";
  return _typeof$g = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o2) {
    return typeof o2;
  ...
  return _createClass$c(RadialBar2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        var props = _objectSpread$d(_objectSpread$d(_objectSpread$d(_objectSpread$d({}, baseProps), {}, {
        ...
        return /* @__PURE__ */ React.createElement(RadialBarSector, _extends$b({}, props, {
          key: "sector-".concat(i)
        }));
      });
    }
    ...
    value: function renderBackground(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        var props = _objectSpread$d(_objectSpread$d(_objectSpread$d(_objectSpread$d(_objectSpread$d({
          cornerRadius: parseCornerRadius(cornerRadius)
        }, rest), {}, {
          fill: "#eee"
    ...
    value: function render() {
      ...
      }, this.renderSectors()), (!isAnimationActive || isAnimationFinished) && LabelList.renderCallByParent(_objectSpread$d({}, this.props), data));
    }
  }], [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(nextProps, prevState) {
...
_defineProperty$g(RadialBar, "displayName", "RadialBar");
_defineProperty$g(RadialBar, "defaultProps", {
  angleAxisId: 0,
  radiusAxisId: 0,
  minPointSize: 0,
  hide: false,
...
_defineProperty$g(RadialBar, "getComposedData", function(_ref2) {
  ...
  var sectors = displayedData.map(function(entry, index) {
    ...
    return _objectSpread$d(_objectSpread$d(_objectSpread$d(_objectSpread$d({}, entry), backgroundSector), {}, {
      payload: entry,
