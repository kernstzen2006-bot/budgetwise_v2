...
const ArrowLeftRight = createLucideIcon("arrow-left-right", __iconNode$u);
const __iconNode$t = [
...
const ChartPie = createLucideIcon("chart-pie", __iconNode$q);
...
const PiggyBank = createLucideIcon("piggy-bank", __iconNode$c);
const __iconNode$b = [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
